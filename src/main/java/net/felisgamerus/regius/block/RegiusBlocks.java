...
public class RegiusBlocks {
    ...
    //Flammable
    public static final DeferredBlock<Block> HOLLOW_OAK_LOG = BLOCKS.register("hollow_oak_log", () -> flammableHollowLog(MapColor.WOOD, MapColor.PODZOL, SoundType.WOOD, false, RegiusBlocks.HOLLOW_STRIPPED_OAK_LOG.get()));
    public static final DeferredBlock<Block> HOLLOW_SPRUCE_LOG = BLOCKS.register("hollow_spruce_log", () -> flammableHollowLog(MapColor.PODZOL, MapColor.COLOR_BROWN, SoundType.WOOD, false, RegiusBlocks.HOLLOW_STRIPPED_SPRUCE_LOG.get()));
    public static final DeferredBlock<Block> HOLLOW_BIRCH_LOG = BLOCKS.register("hollow_birch_log", () -> flammableHollowLog(MapColor.SAND, MapColor.QUARTZ, SoundType.WOOD, false, RegiusBlocks.HOLLOW_STRIPPED_BIRCH_LOG.get()));
    public static final DeferredBlock<Block> HOLLOW_JUNGLE_LOG = BLOCKS.register("hollow_jungle_log", () -> flammableHollowLog(MapColor.DIRT, MapColor.PODZOL, SoundType.WOOD, false, RegiusBlocks.HOLLOW_STRIPPED_JUNGLE_LOG.get()));
    public static final DeferredBlock<Block> HOLLOW_ACACIA_LOG = BLOCKS.register("hollow_acacia_log", () -> flammableHollowLog(MapColor.COLOR_ORANGE, MapColor.STONE, SoundType.WOOD, false, RegiusBlocks.HOLLOW_STRIPPED_ACACIA_LOG.get()));
    public static final DeferredBlock<Block> HOLLOW_DARK_OAK_LOG = BLOCKS.register("hollow_dark_oak_log", () -> flammableHollowLog(MapColor.COLOR_BROWN, MapColor.COLOR_BROWN, SoundType.WOOD, false, RegiusBlocks.HOLLOW_STRIPPED_DARK_OAK_LOG.get()));
    public static final DeferredBlock<Block> HOLLOW_MANGROVE_LOG = BLOCKS.register("hollow_mangrove_log", () -> flammableHollowLog(MapColor.COLOR_RED, MapColor.PODZOL, SoundType.WOOD, false, RegiusBlocks.HOLLOW_STRIPPED_MANGROVE_LOG.get()));
    public static final DeferredBlock<Block> HOLLOW_CHERRY_LOG = BLOCKS.register("hollow_cherry_log", () -> flammableHollowLog(MapColor.TERRACOTTA_WHITE, MapColor.TERRACOTTA_GRAY, SoundType.CHERRY_WOOD, false, RegiusBlocks.HOLLOW_STRIPPED_CHERRY_LOG.get()));
